...
public class CallLineDataController {
  ...
  @GetMapping(value = "/getOHStockLine")
  public List<LinePointDTO> getOHLineData() {
    return this.marketDataService.getOHLineData();
  }

  @GetMapping(value = "/getOHStockcandle")
  public List<CandleStickDTO> getOHCandleData() {
    return this.marketDataService.getOHCandleData();
  }
